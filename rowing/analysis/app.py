...
def get_crossing_times(gpx_data, locations=None, thresh=0.5):
    return pieces.get_crossing_times(gpx_data, locations=locations, thresh=thresh)


@st.cache_data
def get_location_timings(gpx_data, locations=None, thresh=0.5):
    return pieces.get_location_timings(gpx_data, locations=locations, thresh=thresh)


@st.cache_data
def get_fastest_times(gpx_data):
    return pieces.get_fastest_times(gpx_data)
...
def make_stroke_profiles(telemetry_data, piece_data, nres=101):
    return pieces.make_stroke_profiles(telemetry_data, piece_data, nres=nres)
...
def interpolate_power(telemetry_data, dists=0.005, n_iter=10):
    return pieces.interpolate_power(telemetry_data, dists=dists, n_iter=n_iter)
