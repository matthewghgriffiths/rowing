...
class WeatherClient(utils.CachedClient):
    ...
    def load_hourly_weather(self, latitude, longitude, start_time, end_time, **kwargs):
        loc_key = loc_hour_key(latitude, longitude, start_time, end_time)
        key = ("hourly",) + loc_key

    def _hourly_weather_params(self, latitude, longitude, start_time, end_time, **params):
