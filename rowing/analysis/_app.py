...
from rowing.analysis import files, geodesy, splits, static, telemetry
...
DEFAULT_REPORT["report_setup"] = {"figure_height": 1000, "nview": len(REPORT), "toggleother": False, "window": 10}
REPORT = [
...
TIMINGS_REPORT["report_setup"] = {"figure_height": 1000, "nview": len(REPORT), "toggleother": False, "window": 10}
